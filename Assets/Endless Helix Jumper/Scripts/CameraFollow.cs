...
namespace UnityStandardAssets._2D
{
    public class CameraFollow : MonoBehaviour
    {
        ...
        private float lessPos;
        private void SkyboxControl()
        {
            skybox.transform.position = new Vector3(0, 0.00000000000000000000000000000000001f , 0);
                lessPos = transform.position.y;
        }
    }
}
